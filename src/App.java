...
public class App {
    public static void main(String[] args) {
        ...
        Node node2=new Node("127.0.0.1",55001,"B",new ArrayList<String>(Arrays.asList( "Big bang theory", "Breaking bad","Vikings")));
        Node node3=new Node("127.0.0.1",55002,"C",new ArrayList<String>(Arrays.asList("Wire", "Himym", "Last ship")));
